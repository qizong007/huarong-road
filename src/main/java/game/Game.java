...
public class Game {
     ...
     * @return 步数
     */
    public int slidingPuzzleStepFirst(int[][] board,int[][] targetInt,int step,int[] swap) {
     ...
     * @return 步数
     */
    public int slidingPuzzleTimeFirst(int[][] board,int[][] targetInt,int step,int[] swap) {
        //System.out.println("在第"+step+"步交换"+swap[0]+"和"+swap[1]);
        //System.out.println("初始状态：");
        //outputBoard(board);
        int R = board.length, C = board[0].length;
